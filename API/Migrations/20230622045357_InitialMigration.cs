        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    otp = table.Column<string>(type: "nvarchar(6)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_tb_tr_bookings_tb_m_rooms_room_id",
                        column: x => x.room_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tb_m_account_roles_tb_m_accounts_AccountGuid",
                        column: x => x.AccountGuid,
                        principalTable: "tb_m_accounts",
                        principalColumn: "guid",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_tb_m_account_roles_tb_m_roles_RoleGuid",
                        column: x => x.RoleGuid,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tb_m_account_roles_AccountGuid",
                table: "tb_m_account_roles",
                column: "AccountGuid");

            migrationBuilder.CreateIndex(
                name: "IX_tb_m_account_roles_RoleGuid",
                table: "tb_m_account_roles",
                column: "RoleGuid");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tb_tr_bookings_room_id",
                table: "tb_tr_bookings",
                column: "room_id");
        }
